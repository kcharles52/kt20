...
function result() {
	...
	var xItem2 = randomValueFromArray(insertX); //generates the values to replace the second instance of insertx
	var yItem =	randomValueFromArray(insertY);
	var zItem = randomValueFromArray(insertZ);

	newStory = newStory.replace(':insertx:',xItem);
	newStory = newStory.replace(':insertx:',xItem2);//replaces the second instance of insertx in the story
